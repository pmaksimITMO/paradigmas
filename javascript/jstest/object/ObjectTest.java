...
public final class ObjectTest {
    ...
    public static final Selector SELECTOR = selector()
            ...
            .variant(
                    ...
                    sumsq(5, new int[][]{{1, 1, 1}, {5, 13, 13}, {13, 21, 1}, {1, 1, 5}, {5, 1, 13}, {5, 1, 1}, {1, 1, 1}, {13, 13, 1}, {5, 5, 21}, {1, 5, 5}, {13, 1, 5}, {1, 5, 5}}),
                    ...
                    distance(5, new int[][]{{1, 1, 1}, {49, 75, 1}, {23, 1, 23}, {23, 1, 49}, {1, 1, 75}, {23, 49, 23}, {1, 49, 49}, {1, 75, 23}, {23, 49, 23}, {1, 49, 1}, {23, 1, 23}, {23, 23, 49}})
            )
            .variant(
                    "SumrecHMean",
                    ...
                    sumrec(5, new int[][]{{1, 1, 1}, {10, 23, 23}, {23, 36, 1}, {1, 1, 10}, {16, 3, 29}, {10, 1, 1}, {1, 1, 1}, {23, 23, 1}, {10, 10, 36}, {1, 10, 10}, {23, 1, 10}, {1, 10, 10}}),
                    ...
                    hmean(5, new int[][]{{1, 1, 1}, {165, 249, 1}, {81, 1, 81}, {81, 1, 165}, {1, 1, 249}, {81, 165, 81}, {1, 165, 165}, {1, 249, 81}, {81, 165, 81}, {1, 165, 1}, {81, 1, 81}, {81, 81, 165}})
            )
            .selector();
